		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					onclick="history.go(-1);">&times;</button>
						...
						<div class="col-sm-10">
							...
							<div class="panel panel-default">
								<form class="form-horizontal" method="POST"
									action=<%= "UpdateLessonServlet?id=" + idLesson%>>
									<div class="panel-body">
										<div class="panel-heading">Modifica lezione</div>
										<p>Nome Lezione:</p>
										<div class="input-group">
											<span class="input-group-addon"></span> <input
												class="form-control" name="name" type="text"
												id="nomelezione" value="<%= lesson.getName()%>" required>
										</div>
										<br> <br>
										<p>Descrizione:</p>
										<div class="input-group">
											...
											<textarea class="form-control" name="description" rows="5"
												cols="40" id="description"><%= lesson.getDescription()%> </textarea>
										</div>
										<br> <br>
										<p>Classe</p>
										<div class="input-group">
											<span class="input-group-addon"></span>
											<textarea class="form-control" name="class" rows="5"
												cols="40" id="class"><%= lesson.getClassroom()%> </textarea>
										</div>
										<br> <br>
										<p>Corso:</p>
										<div class="form-group">
											<select class="form-control" name="fkCourse" id="courselist1"
												required>
										...
										<div class="input-group">
											<span class="input-group-addon"></span> <input
												...
												placeholder="aaaa-mm-gg" value="<%= lesson.getData()%>"
												required>
										</div>
										<br> <br>
										<p>Orario di Inizio:</p>
										<div class="input-group bootstrap-timepicker timepicker">
											<input id="timepicker1" name="startTime" type="text"
										...
										<p>Orario di Fine:</p>
										<div class="input-group bootstrap-timepicker timepicker">
											<input id="timepicker2" name="endTime" type="text"
												class="form-control input-small"
