...
<div id="infoDialog1" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-inline" name="lessonform2" method="GET"
				action="deleteLesson.jsp">
				<input type='hidden' name="idLesson2" id="idLess2"> <input
					type="submit" class="btn btn-white" value="Elimina">
			</form>
			<%
				}
			%>
...
<div id="infoDialog2" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="descriptionInfo2"></div>
			<%
				if (loggedPerson.isAdmin() || loggedPerson.getTypeAccount().equals("professor")) {
			%>
			<form class="form-inline" name="seminarform" method="GET"
				action="editSeminar.jsp">
				<input type='hidden' name="idSeminar" id="idSemi"> <input
					type="submit" class="btn btn-blue" value="Modifica">
			</form>
			<form class="form-inline" name="seminarform2" method="GET"
				action="deleteSeminar.jsp">
				<input type='hidden' name="idSeminar2" id="idSemi2"> <input
					type="submit" class="btn btn-white" value="Elimina">
			</form>
			<%
				}
