...
('ajeje@hotmail.it', 4, 0),
('ajeje@hotmail.it', 7, 0),
('ajeje@hotmail.it', 9, 0),
('ajeje@hotmail.it', 12, 0),
('ariemma@hotmail.it', 2, 0),
('ariemma@hotmail.it', 3, 0),
('ariemma@hotmail.it', 5, 0),
('ariemma@hotmail.it', 6, 0),
('ariemma@hotmail.it', 8, 0),
('ariemma@hotmail.it', 10, 0),
('ariemma@hotmail.it', 11, 0),
('ariemma@hotmail.it', 13, 0),
('ariemma@hotmail.it', 14, 0),
('ariemma@hotmail.it', 15, 0),
('ballo@hotmail.it', 1, 0),
('ballo@hotmail.it', 4, 0),
('ballo@hotmail.it', 7, 0),
('ballo@hotmail.it', 9, 0),
('ballo@hotmail.it', 12, 0),
('dinucci@hotmail.it', 1, 0),
('dinucci@hotmail.it', 4, 0),
('dinucci@hotmail.it', 7, 0),
('dinucci@hotmail.it', 9, 0),
('dinucci@hotmail.it', 12, 0),
('elisa@hotmail.it', 1, 0),
('elisa@hotmail.it', 4, 0),
...
('minichiello@hotmail.it', 6, 0),
('minichiello@hotmail.it', 8, 0),
('minichiello@hotmail.it', 10, 0),
('minichiello@hotmail.it', 11, 0),
