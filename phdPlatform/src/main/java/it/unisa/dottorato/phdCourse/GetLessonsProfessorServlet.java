 ...
 * @author Raff
 */
@WebServlet(name = "GetLessonsProfessor", urlPatterns = {"/GetLessonsProfessor"})
public class GetLessonsProfessorServlet extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ArrayList<Lesson> lessons = (ArrayList<Lesson>) CalendarManager.getInstance().getLessonsOfProfessor(fkCourse, loggedPerson); 
