...
/**Servlet incaricata ad effettuare la richiesta di visualizzazione di tutte le lezioni
 *
 * @author Rembor
 */
@WebServlet(name = "GetAllLessonOfProfessor", urlPatterns = {"/GetAllLessonOfProfessor"})
public class GetAllLessonOfProfesser  extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ArrayList<Lesson> lessons =  CalendarManager.getInstance().getAllLessonOfProfessor(); // da modificare ancora
