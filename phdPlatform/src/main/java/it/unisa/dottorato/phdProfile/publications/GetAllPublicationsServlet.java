...
/**Servlet incaricata ad effettuare la richiesta di visualizzazione di tutte le pubblicazioni
 * di un dato dottorando
 *
 * @author gemmacatolino
 */
@WebServlet(name = "GetAllPublicationsServlet", urlPatterns = {"/GetAllPublicationsServlet"})
public class GetAllPublicationsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(GetAllPublicationsServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
