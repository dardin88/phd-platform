<%-- 
    Document   : aggiungiLezione
    Created on : 26-dic-2015, 0.39.25
    Author     : Rembor
--%>
<%-- 
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="POST" action="AddLessonServlet">
                                        ...
                                        <table width="90%" align="center">
                                            <tr><td>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" name="idLesson" type="text" required>
                                                    </div>
                                                    <br>
                                                    <br>
                                                     <p>Data :</p>
                                                    ...
                                                    <p>Corso:</p>
                                                     <div class="input-group">
                                                        ...
                                                        <select class="form-control" name="fkCourse" id="CycleList" required onclick="selectedItem()"> 
                                                          <option value="default" >Seleziona il nome del corso</option>
