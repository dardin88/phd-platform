                ...
                <div class="page-container">
                    ...
                    <div class="main-content" id="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <%
                                    int idLesson = (Integer.parseInt(request.getParameter("idLesson2")));
                                    Lesson lesson = CalendarManager.getInstance().getLessonById(idLesson);%>
                                <div class="panel panel-default">
                                    <form class="form-horizontal" method="POST"  action=<%= "DeleteLessonServlet?id=" + idLesson%> >

                                        <div class="panel-heading">
                                            <h1> Elimina Lezione </h1>
                                            <div class="panel-body">
                                                <div class="panel-heading">
                                                    Sei sicuro di eliminare la lezione <%= lesson.getName()%>?                     
                                                </div>
                                                <div>
