...
public class UpdateStudentPhdClassServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            StudentCurriculumcic aStudentClass = new StudentCurriculumcic();
            aStudentClass.setFK_Student(SSN);
            aStudentClass.setFK_PhdClass(Integer.parseInt(idCycle));

            result.put("result", true);

            try {
                CurriculumcicManager.getInstance().updateStudentPhdClass(aStudentClass);
