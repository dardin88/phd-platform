...
/**Servlet incaricata ad effettuare la richiesta di cancellazione di una collaborazione
 *
 * @author gemmacatolino
 */
@WebServlet(name = "DeleteCollaborationServlet", urlPatterns = {"/dottorato/DeleteCollaborationServlet"})
public class DeleteCollaborationServlet extends HttpServlet {
     ...
     * per effettuare la richiesta di cancellazione della collaborazione
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idCollaboration = request.getParameter("idCollaboration");
        try {
