 ...
 * @author matteo
 */
@WebServlet(name = "getAllSeminarOf", urlPatterns = {"/getAllSeminarOf"})
public class getAllSeminarOfServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, SQLException, IdException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(getAllSeminarOfServlet.class.getName()).log(Level.SEVERE, null, ex);
