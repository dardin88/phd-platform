 ...
 * @author Rembor
 */
@WebServlet(name = "GetAllLessonOfACourse", urlPatterns = {"/GetAllLessonOfACourse"})
public class GetAllLessonOfACourseServlet  extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
               ...
               int lessons =  CalendarManager.getInstance().getAllLessonOfCourse(); // da modificare ancora
